 ...
 * @author dumspicy
 */
@WebServlet(name="SearchControl", urlPatterns={"/searchProduct"})
public class SearchControl extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        int addressId = 0;
        try {
            typeId = Integer.parseInt(request.getParameter("pitch-type"));
            addressId = Integer.parseInt(request.getParameter("pitch-location"));
        } catch (Exception e) {
            typeId = 0;
            addressId = 0;
        }
